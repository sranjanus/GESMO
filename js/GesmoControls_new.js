 ...
 */
 ...
 THREE.GesmoControls = (function() {
 	...
 	var PI_2 = Math.PI * 2;
      ...
      var GesmoControls = function(camera, controller, invert, posSphere){
            this.camera = camera;
      	...
      	this.rotationMomentum = this.camera.quaternion.clone();
      ...
      GesmoControls.prototype.update = function(){
      	 ...
      	 // check if we have a frame or not
          ...
          if(this.shouldPick(anchorHands, hands)){
      	 ...
      	 this.camera.quaternion.slerp(this.rotationMomentum, this.rotationSlerp);
      	 this.camera.quaternion.normalize();

      	 this.camera.scale.lerp(this.scaleMomentum, this.scaleDecay);
      }

      GesmoControls.prototype.shouldTranslate = function(anchorHands, hands){
      ...
      GesmoControls.prototype.shouldDrag = function(anchorHands, hands){

      }

      GesmoControls.prototype.shouldRelease = function(anchorHands, hands){
      ...
      GesmoControls.prototype.applyRotation = function(anchorHands, hands){
      ...
      GesmoControls.prototype.pick = function(anchorHands, hands){
            var handMesh = hands[0].data('riggedHand.mesh');
            handMesh.scenePosition(hands[0].indexFinger.tipPosition, this.posSphere.position);

            var newEvent = new CustomEvent('gesmo.controls.pick', {
                  'detail': {
                        position: this.posSphere.position
                  }
            });
      ...
      GesmoControls.prototype.drag = function(anchorHands, hands){

      }

      GesmoControls.prototype.release = function(anchorHands, hands){

      }

      GesmoControls.prototype.playorPause = function(anchorHands, hands){

      }

      GesmoControls.prototype.moveToNext = function(anchorHands, hands){

      }

      GesmoControls.prototype.moveToPrevious = function(anchorHands, hands){

      }

      GesmoControls.prototype.isEngaged = function(h){
      	return h && (h.pinchStrength > this.pinchThreshold);
      }

      GesmoControls.prototype.isLeftEngaged = function(h){
            return h && (h.type == "left") &&  (h.pinchStrength > this.pinchThreshold);
      }

      GesmoControls.prototype.getTranslation = function(anchorHands, hands){
        ...
        GesmoControls.prototype.getRotation = function(anchorHands, hands) {
