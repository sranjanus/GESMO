...
THREE.GesmoControls = (function () {
  ...
  var GesmoControls = function (object, controller, invert) {
    this.object = object;
  ...
  GesmoControls.prototype.update = function() {
    ...
    if (hands.length) {
      var whichHand = this.whichHand(hands);
      if(whichHand == 0){
          // translation
  ...
  GesmoControls.prototype.whichHand = function(hands){
      if(hands.length == 1){
  ...
  GesmoControls.prototype.shouldScale = function (anchorHands, hands) {
    var isEngaged = this.isEngaged.bind(this);
  ...
  GesmoControls.prototype.shouldRotate = function (anchorHands, hands) {
    ...
    return anchorHands.length > 1
        && hands.length > 1
        && anchorHands.some(isEngaged)
        && hands.some(isEngaged);
  }
  ...
  GesmoControls.prototype.applyScale = function (anchorHands, hands) {
  ...
  GesmoControls.prototype.getScale = function(anchorHands, hands) {
